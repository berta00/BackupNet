...
class DebugTest {
    ...
    void fileFragmentation() throws Exception {
        ...
        System.out.println();
        System.out.println("execution time:     " + String.format("%.8f", deltaTime * Math.pow(10, -9)) + "s");
        ...
        deltaTime = System.nanoTime() - startTime;
        FileInputStream file_5_1_in_str = new FileInputStream(new File("test/fragmentation/files/04.MOV"));
        FileInputStream file_5_2_in_str = new FileInputStream(new File("test/fragmentation/files/04-recovered.MOV"));

        assertArrayEquals(file_5_1_in_str.readAllBytes(), file_5_2_in_str.readAllBytes());
        System.out.println();
        System.out.println("execution time:     " + String.format("%.8f", deltaTime * Math.pow(10, -9)) + "s");
    ...
    @org.junit.jupiter.api.Test
    void directoryFragmentation() throws Exception {
        long startTime;
        long deltaTime;

        // ./test/fragmentation/files/subFiles4
        System.out.println("\n\n");
        startTime = System.nanoTime();
        Debug.directoryFragmentation("test/fragmentation/files/subFiles1");
        deltaTime = System.nanoTime() - startTime;
        /*
        FileInputStream file_1_1_in_str = new FileInputStream(new File("test/fragmentation/files/01.txt"));
        FileInputStream file_1_1_2_in_str = new FileInputStream(new File("test/fragmentation/files/01-recovered.txt"));
